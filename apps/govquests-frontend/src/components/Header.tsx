...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full z-50 bg-background/70 sticky top-0">
      <div className="flex justify-between items-center align-middle w-full max-w-[1200px]  mx-auto py-4 px-4">
