...
module ActionTracking
  class ActionTest < Test
    ...
    def test_create_a_new_action
      ...
      @action.create(action_type, data)
      ...
      assert_equal data[:content], event.data[:action_data][:description]
      assert_equal data[:document_url], event.data[:action_data][:action_data][:document_url]
    end
  end
end
