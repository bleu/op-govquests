module Mutations
  class CompleteActionExecution < BaseMutation
    ...
    argument :ens_completion_data, Types::EnsStartDataInput, required: false, description: "Completion data for Read Document action"

    field :action_execution, Types::ActionExecutionType, null: true
    field :errors, [String], null: false

    def resolve(execution_id:, nonce:, action_type:, gitcoin_score_completion_data: nil, read_document_completion_data: nil, ens_completion_data: nil)
