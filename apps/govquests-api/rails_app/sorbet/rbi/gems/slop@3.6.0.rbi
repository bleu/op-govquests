...
# source://slop//lib/slop/option.rb#1
class Slop
  include ::Enumerable
  ...
  #
  # source://slop//lib/slop.rb#675
  def clean(object); end

  # source://slop//lib/slop.rb#679
  ...
  #
  # source://slop//lib/slop.rb#593
  def extract_option(flag); end

  # source://slop//lib/slop.rb#647
  ...
  class << self
    ...
    # Returns a new instance of Slop.
    #
    # source://slop//lib/slop.rb#62
    def parse!(items = T.unsafe(nil), config = T.unsafe(nil), &block); end
  end
end

# source://slop//lib/slop/commands.rb#2
class Slop::Commands
  include ::Enumerable
  ...
  #
  # source://slop//lib/slop/commands.rb#36
  def initialize(config = T.unsafe(nil), &block); end
  ...
  #
  # source://slop//lib/slop/commands.rb#97
  def [](key); end

  # Returns the value of attribute arguments.
  #
  # source://slop//lib/slop/commands.rb#5
  def arguments; end
  ...
  #
  # source://slop//lib/slop/commands.rb#56
  def banner(banner = T.unsafe(nil)); end
  ...
  #
  # source://slop//lib/slop/commands.rb#6
  ...
  #
  # source://slop//lib/slop/commands.rb#78
  def default(config = T.unsafe(nil), &block); end

  # Enumerable interface.
  #
  # source://slop//lib/slop/commands.rb#116
  def each(&block); end
  ...
  #
  # source://slop//lib/slop/commands.rb#88
  def global(config = T.unsafe(nil), &block); end

  # Returns the help String.
  #
  # source://slop//lib/slop/commands.rb#160
  def help; end

  # Returns the inspection String.
  #
  # source://slop//lib/slop/commands.rb#176
  def inspect; end
  ...
  #
  # source://slop//lib/slop/commands.rb#68
  ...
  #
  # source://slop//lib/slop/commands.rb#125
  ...
  #
  # source://slop//lib/slop/commands.rb#135
  def parse!(items = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://slop//lib/slop/commands.rb#111
  def present?(key); end

  # Returns a nested Hash with Slop options and values. See Slop#to_hash.
  #
  # source://slop//lib/slop/commands.rb#155
  def to_hash; end
...
class Slop::Option
  ...
  #
  # source://slop//lib/slop/option.rb#33
  ...
  # @return [Boolean]
  #
  # source://slop//lib/slop/option.rb#71
  ...
  # Returns nothing.
  #
  # source://slop//lib/slop/option.rb#83
  def call(*objects); end

  # Returns the value of attribute config.
  #
  # source://slop//lib/slop/option.rb#20
  def config; end
  ...
  # @return [Boolean]
  #
  # source://slop//lib/slop/option.rb#66
  def expects_argument?; end

  # Returns the help String for this option.
  #
  # source://slop//lib/slop/option.rb#127
  def help; end

  # Returns the String inspection text.
  #
  # source://slop//lib/slop/option.rb#151
  def inspect; end

  # Returns the String flag of this option. Preferring the long flag.
  #
  # source://slop//lib/slop/option.rb#76
  def key; end
  ...
  #
  # source://slop//lib/slop/option.rb#107
  def value; end
  ...
  #
  # source://slop//lib/slop/option.rb#92
  ...
  #
  # source://slop//lib/slop/option.rb#181
  ...
  #
  # source://slop//lib/slop/option.rb#164
